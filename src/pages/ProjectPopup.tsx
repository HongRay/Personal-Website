    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#181616]">
        <div className="max-w-4xl mx-auto px-6">
          ...
          {/* Card */}
          <div className="bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in dark:bg-[#c6c6c6]">
            {/* Media */}
            <ProjectCarousel images={project.image} />
            {/* Content */}
            <div className="px-8 pt-0 pb-8">
              <h1 className="text-3xl font-bold text-[#254194] mb-2 dark:text-[#0d1b53]">{project.title}</h1>
              {/* Overview */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Overview</h3>
                <p className="text-gray-600 leading-relaxed whitespace-pre-line dark:text-gray-800">{project.description}</p>
              </div>
                  ...
                  <ul className="space-y-3">
                    {project.achievements.map((item, index) => (
                      <li key={index} className="flex items-start gap-3 group">
                        ...
                        <span className="text-gray-600 leading-relaxed dark:text-gray-800">{item}</span>
                      </li>
                    ))}
                  </ul>
                </div>
